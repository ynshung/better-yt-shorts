...
export default function Announcement() {
  ...
  const announcementDismissed = localStorage.getItem("byt-announcement");

  if (
    !showAnnouncement ||
    (announcementDismissed !== null &&
      parseInt(announcementDismissed) >= currAnnouncement)
  ) {
    return null;
  }
  ...
  return (
    <div className="announcement">
      ...
      <a
        ...
        className="close-btn"
        title="Dismiss"
        onClick={() => handleDismiss(currAnnouncement)}
      >
        &times;
      </a>
    </div>
